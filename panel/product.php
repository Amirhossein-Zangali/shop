...
<div class="d-flex flex-column flex-column-fluid" data-select2-id="select2-data-133-drwv">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid" data-select2-id="select2-data-kt_app_content">
								...
								<div id="kt_app_content_container" class="app-container container-xxl" data-select2-id="select2-data-kt_app_content_container">
									<!--begin::Form-->
									<form id="kt_ecommerce_add_product_form" method="post" action="" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework" data-kt-redirect="../../demo1/dist/apps/ecommerce/catalog/products.html" data-select2-id="select2-data-kt_ecommerce_add_product_form">
														...
														<div class="card card-flush py-4">
															...
															<div class="card-body pt-0">
																...
																<div class="mb-10 fv-row fv-plugins-icon-container">
																	...
																	<!--end::Tags-->
																	<!--begin::Input-->
																	<input type="text" name="product_name" class="form-control mb-2" placeholder="نام محصول" value="<?php echo $title;?>">
																	<!--end::Input-->
																	<!--begin::توضیحات-->
																...
																<div>
																	...
																	<!--end::Tags-->
																	<!--begin::or-->
                                                                    <textarea name="content" name="product_content" id="" cols="30" rows="10" class="form-control"><?php echo $content;?></textarea>
                                                                    <!--end::or-->
																	<!--begin::توضیحات-->
														...
														<div class="card card-flush py-4">
															...
															<div class="card-body pt-0">
																...
																<div class="mb-10 fv-row fv-plugins-icon-container">
																	...
																	<!--end::Tags-->
																	<!--begin::Input-->
																	<input type="text" name="product_price" class="form-control mb-2" placeholder="قیمت محصول" value="<?php echo $price;?>">
																	<!--end::Input-->
																	<!--begin::توضیحات-->
																...
																<div class="mb-10 fv-row fv-plugins-icon-container">
																	...
																	<!--end::Tags-->
																	<!--begin::Input-->
																	<input type="text" name="product_discount" class="form-control mb-2" placeholder="قیمت محصول" value="<?php echo $discount;?>">
																	<!--end::Input-->
																	<!--begin::توضیحات-->
