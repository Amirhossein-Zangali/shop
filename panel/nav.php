            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="<?php echo image_url( $user['photo'] );?>" alt="user" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="<?php echo image_url( $user['photo'] );?>" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::کاربرname-->
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="mailto:<?php echo $user['email'];?>" class="fw-semibold text-muted text-hover-primary fs-7"><?php echo $user['email'];?></a>
                                </div>
                                <!--end::کاربرname-->
                            </div>
                        </div>
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="<?php echo url('/login.php?action=logout');?>" class="menu-link px-5">خروج</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
